...
<body class="bg-gray-50 font-sans antialiased">
    <!-- Navbar -->
    <nav class="bg-gray-900 text-white shadow-lg sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-show="mobileMenuOpen" x-transition class="md:hidden pb-4">
                @auth
                    @if(auth()->user()->isAdmin())
                        <!-- Admin Mobile Menu -->
                        <a href="{{ route('admin.dashboard') }}" class="block py-2 text-red-500">Admin Panel</a>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="block w-full text-left py-2 hover:text-red-500 transition">Logout</button>
                        </form>
                    @else
                        <!-- User Mobile Menu -->
                        <a href="{{ route('home') }}" class="block py-2 hover:text-red-500 transition">Beranda</a>
                        <a href="{{ route('catalog.index') }}" class="block py-2 hover:text-red-500 transition">Katalog</a>
                        <a href="{{ route('test-drive.index') }}" class="block py-2 hover:text-red-500 transition">Test Drive</a>
                        <a href="#" class="block py-2 hover:text-red-500 transition">Kontak</a>
                        <a href="{{ route('dashboard') }}" class="block py-2 hover:text-red-500 transition">Dashboard</a>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="block w-full text-left py-2 hover:text-red-500 transition">Logout</button>
                        </form>
                ...
                @else
                    ...
                    <a href="{{ route('home') }}" class="block py-2 hover:text-red-500 transition">Beranda</a>
                    <a href="{{ route('catalog.index') }}" class="block py-2 hover:text-red-500 transition">Katalog</a>
                    <a href="{{ route('login') }}" class="block py-2 hover:text-red-500 transition">Login</a>
                    <a href="{{ route('register') }}" class="block py-2 text-red-500">Daftar</a>
                @endauth
            </div>
        </div>
    </nav>
